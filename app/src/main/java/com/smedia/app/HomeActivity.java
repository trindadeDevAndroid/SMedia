...
public class HomeActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		try{
			...
			bottomnavigation1.getMenu().add(0, 0, 0, "Início").setIcon(R.drawable.home_icon);
			bottomnavigation1.getMenu().add(0, 1, 0, "Perfil").setIcon(R.drawable.perfil_icon);
			FragmentAdapter.setTabCount(2);
			viewpager1.setAdapter(FragmentAdapter);
		}catch(Exception e){
	...
	public class FragmentAdapterFragmentAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int _position) {
			...
			if (_position == 1) {
				return new PerfilFragmentActivity();
			}
			return null;
		}
	}
